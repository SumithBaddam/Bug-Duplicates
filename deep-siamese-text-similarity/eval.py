...
tf.flags.DEFINE_string("vocab_filepath", "runs/1526021545/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1526021545/checkpoints/model-5000", "Load trained model checkpoint (Default: None)")
